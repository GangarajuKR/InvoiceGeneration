package com.invoice.InvoiceGeneration;
...
public class invoice {
  ...
  String InvoiceTitle = new String("FOOD ORDER INVOICE GENERATION");
  String SubTitle = new String("Invoice For Food Order");
  ...
  void WriteInvoice() {
    ...
    try {
      ...
      cs.close();
      //Save the PDF
     // String path = "C:\\Users\\HP\\Pictures\\Camera\\Saved Games\\Downloads\\hii.pdf";
      invc.save("C:\\Users\\HP\\Pictures\\Camera\\Saved Games\\Downloads\\hii.pdf");
